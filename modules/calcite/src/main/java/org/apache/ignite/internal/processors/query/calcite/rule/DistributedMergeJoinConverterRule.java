 ...
 */
public class DistributedMergeJoinConverterRule extends AbstractIgniteConverterRule<LogicalJoin> {
    /** */
    public static final RelOptRule INSTANCE = new DistributedMergeJoinConverterRule();

    /**
     * Creates a converter.
     */
    public DistributedMergeJoinConverterRule() {
        super(LogicalJoin.class, "DistributedMergeJoinConverter");
    }
    ...
    @Override protected PhysicalNode convert(RelOptPlanner planner, RelMetadataQuery mq, LogicalJoin rel) {
        ...
        return new IgniteDistributedMergeJoin(cluster, outTraits, left, right, rel.getCondition(), rel.getVariablesSet(), rel.getJoinType());
    }
}
