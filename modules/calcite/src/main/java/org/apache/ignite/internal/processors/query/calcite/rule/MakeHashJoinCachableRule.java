...
public class MakeHashJoinCachableRule extends RelRule<MakeHashJoinCachableRule.Config> implements TransformationRule {
    ...
    public void onMatch(RelOptRuleCall call) {
        assert call.rel(0) instanceof IgniteDistributedHashJoin;
        assert call.rel(2) instanceof IgniteTableScan;

        IgniteDistributedHashJoin join = call.rel(0);
        ...
        call.transformTo(new CacheableIgniteDistributedHashJoin(join.getCluster(), join.getTraitSet(), join.getLeft(), newScan,
    ...
    public boolean matches(RelOptRuleCall call) {
        ...
        // dont occur in a TableScan with a HashJoin above it.
        if (scan.projects() != null) return false;
        return scan.condition() != null || scan.requiredColumns() != null;
    }
    ...
    public interface Config extends RelRule.Config {
        ...
        Config DEFAULT = ImmutableMakeHashJoinCachableRule.Config.of()
            .withOperandSupplier(b0 ->
                b0.operand(IgniteDistributedHashJoin.class).inputs(
